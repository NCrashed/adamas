...
fn a_handled_strategy_is_distinguishable_by_its_handler() {
    ...
    for kept in ["True", "False"] {
        ...
        // Кадров продолжения ноль: программа тиха (ветка `keep` хвостовая,
        // §3.4, вопрос 74), операция бежит на месте, и тело не дробится. До
        // первой ступени вопроса 74 кадров было два - операция `keep` и вызов
        // `asked` - и блоков семь; это была цена второй формы, и вот её
        // снятие числом.
        assert_eq!(
            allocated, 5,
