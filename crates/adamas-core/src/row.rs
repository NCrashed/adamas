...
//! в ядре нет.
//!
//! Стоит `ε` **под связыванием**, вместе с `B`, и вправе назвать аргумент:
//! `(0 r : Region) -> {Alloc r} Nat` - эффект того региона, который передали
//! (§3.6). Применение инстанцирует row тем же аргументом, что и кодомен.
//!
//! # Что здесь есть
//!
