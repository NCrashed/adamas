...
/// ставится ровно по кратности `1`. Но кратность ограничивает употребление
/// **вызываемым**, а не алиасинг (§10 вопрос 149): `ω`-значение, названное
/// однажды, в позицию `1` проходит, и объект внутри вызываемой функции
/// разделён.
///
