...
impl<'a> Elaborator<'a> {
    ...
    /// ПРОБА (а′): написан ли ожидаемым типом именно `Array n UInt8`.
    ///
    ...
    /// над `arrayNew`, то есть ровно тем, что автор написал бы руками; нулевые
    /// байты пропущены - `arrayNew` уже залил ими весь блок.
