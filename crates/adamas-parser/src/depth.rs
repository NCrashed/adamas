...
//! `let`, операторы блока, звенья цепочки операторов, - и каждый их элемент
//! ставит звено. Другие собираются соседями - элементы кортежа и списка, ветки
//! `case`, конструкторы семейства, - и стоят все на одной глубине.
