  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        # расширение в настоящем extension host'е. Цена замерена: neovim -
        # 257 MiB замыкания, vscodium - 421 MiB докачки поверх остального.
        #
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          #
          # Значение `absent` у любой из трёх - объявленное отсутствие
