...
//! над плоскими данными» — то, ради чего §4.11 писался. Различий с `pure`
//! три, и разность блоков называет каждое числом — **семь блоков на лист**
//! (2026-09-12): четыре на операцию, два на два лишних кадра дробления (точек
//! приостановки на лист три против нуля) и один на переиспользование ячейки
//! листа, не проходящее через границу куска. Перевода плоского значения в
//! слово в этих семи нет: `handled-flat − handled` равно ровно двум блокам на
//! лист на всех трёх глубинах, то есть одним кадрам.
//!
//! По времени за вычетом `floor` — **1.68 / 1.56 / 1.62** раза против `pure`
//! на глубинах 14 / 16 / 18.
//!
