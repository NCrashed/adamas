...
--
-- Клиент один на сеанс. `root_dir` - текущий каталог, а не каталог файла:
-- сегодня `adamas check` работает с одним файлом (многофайловость - предпосылка
-- package manager'а, §7.3, следующая волна), и сервер держит все открытые
-- буферы в одной таблице. Каталог файла завёл бы по серверу на каждый подкаталог
